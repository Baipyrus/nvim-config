...
return {
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    dependencies = {
      ...
      -- Useful for more than one undo history, using telescope as a UI
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>su', telescope.extensions.undo.undo, { desc = '[S]earch [S]elect Telescope' })
      ...
      vim.keymap.set('n', '<leader>gb', utils.git_branches, { desc = '[G]it [B]ranches' })
